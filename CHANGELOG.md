...
* **ci:** build test files in CodeQL to scan all Go sources ([0b8eb57](https://github.com/poweradmin/terraform-provider-poweradmin/commit/0b8eb57a0a392f9e230105cd578057e7a71cdd02))
...
* **deps:** bump actions/setup-go in the github-actions group ([e9f8fae](https://github.com/poweradmin/terraform-provider-poweradmin/commit/e9f8faeea4b24a7b0a1ea20cf228a7d75e08251d))
...
* **deps:** bump github.com/hashicorp/terraform-plugin-docs in /tools ([36e6162](https://github.com/poweradmin/terraform-provider-poweradmin/commit/36e6162cc9353b01c600ccd695cfff41456c7ef8))
* **deps:** bump github.com/hashicorp/terraform-plugin-testing ([b1238cb](https://github.com/poweradmin/terraform-provider-poweradmin/commit/b1238cb9d27ffeda9945a2330e1f8722a259edcf))
...
* **deps:** bump github/codeql-action in the github-actions group ([ef02234](https://github.com/poweradmin/terraform-provider-poweradmin/commit/ef02234815b2e08e120599ff3359e7929d75dcdd))
* **deps:** bump go to 1.26.3 and golang.org/x/net to v0.53.0 ([f03f01a](https://github.com/poweradmin/terraform-provider-poweradmin/commit/f03f01a46fd78d1d5b12d170d1176191a85572ae))
* **deps:** bump go to 1.26.3 and golang.org/x/net to v0.53.0 to fix govulncheck findings ([62d58c0](https://github.com/poweradmin/terraform-provider-poweradmin/commit/62d58c01f348fa6e72463b69fddcdbfe5ba3c711))
* **deps:** bump googleapis/release-please-action ([d93a0f4](https://github.com/poweradmin/terraform-provider-poweradmin/commit/d93a0f4227f00f25a3f48f65d613ffa6001ec143))
...
* **deps:** bump the github-actions group with 2 updates ([f206656](https://github.com/poweradmin/terraform-provider-poweradmin/commit/f20665659258cec1b8899abe0342c391a0711cb3))
...
* **deps:** bump the github-actions group with 2 updates ([2a427c7](https://github.com/poweradmin/terraform-provider-poweradmin/commit/2a427c7cdeac622dcd06f42c0abb3f256b104b99))
